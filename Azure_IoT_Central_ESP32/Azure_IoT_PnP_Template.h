 ...
 */
int azure_pnp_send_telemetry(azure_iot_t* azure_iot,char* event, char* product,int currentAmount, int dispensedAmount, int price, char* date, float product1Mass, float product2Mass, float product3Mass, float product4Mass);
